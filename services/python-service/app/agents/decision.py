...
class DecisionAgent(BaseAgent):
    ...
    def aggregate_decisions(self):
        ...
        try:
            ...
            print("[DecisionAgent] Lỗi: Không import được OpenAI từ llama_index.llms.openai.")
            return {"decision": "reject", "reason": "Không thể truy cập LLM để tổng hợp quyết định."}
        ...
        llm = OpenAI(api_key=api_key, model='gpt-4.1')
        try:
