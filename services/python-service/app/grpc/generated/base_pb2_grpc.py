...
class BaseServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                '/base.BaseService/SayHello',
                request_serializer=base__pb2.HelloRequest.SerializeToString,
                response_deserializer=base__pb2.HelloReply.FromString,
...
def add_BaseServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SayHello': grpc.unary_unary_rpc_method_handler(
                    servicer.SayHello,
                    request_deserializer=base__pb2.HelloRequest.FromString,
                    response_serializer=base__pb2.HelloReply.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'base.BaseService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('base.BaseService', rpc_method_handlers)
...
class BaseService(object):
    ...
    def SayHello(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/base.BaseService/SayHello',
            base__pb2.HelloRequest.SerializeToString,
            base__pb2.HelloReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
