...
export function checkStudentValid(student) {
    ...
    if (student.class_id === null || student.class_id === undefined || student.class_id === "") {
        console.error("Student class is missing");
        return false;
    }
    if (student.university === null || student.university === undefined || student.university === "") {
        console.error("Student university is missing");
        return false;
    }
    if (student.student_card_front === null || student.student_card_front === undefined || student.student_card_front === "") {
        console.error("Student card front is missing");
        return false;
    }
    if (student.student_card_back === null || student.student_card_back === undefined || student.student_card_back === "") {
...
export function checkAcademicValid(academic) {
    ...
    if (academic.gpa === null || academic.gpa === undefined || academic.gpa === "") {
        return false;
    }
